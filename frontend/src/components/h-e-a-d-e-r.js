...
const HEADER = (props) => {
  return (
    <div className={` ${styles['Nav-bar']} ${styles[props.rootClassName]} `}>
      <nav data-role="Header" className={styles['Navbar']}>
        <img src={props.image_src} alt="image" className={styles['image']} />
        ...
        <div className={styles['Right-side']}>
          <div className={styles['Links-container']}>
            <Link to="/userportal/" className={styles['navlink']}>
              {props.Home}
            </Link>
            <a
          ...
          <div className={styles['Nav']}>
            ...
            <div className={styles['Right-side1']}>
              <div className={styles['Links-container1']}>
                ...
                <span className={styles['text2']}>Tour Packages</span>
                <span>Contact</span>
              </div>
...
HEADER.defaultProps = {
  image_src1: '/playground_assets/my-profile-icon-png-3-200h.png',
  image_src: '/playground_assets/fire_fly_logo-200h.png',
  rootClassName: '',
  link_text: '/userportal/userprofile',
  Home: 'Home',
  image_alt1: 'image',
  link_text1: '/userportal/usersearch',
  link_text12: '/userportal/usersearch',
