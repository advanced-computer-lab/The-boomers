...
class userReturnsearch extends Component {
  constructor(props) {
    super(props);
    this.state = {
      flights: [],
      depID : this.props.location.flightID ,
      returnID : "",
    };
  }
  ...
  componentDidMount() {
   ...
   const returnFlightData = {
    departure_airport: this.props.location.flightData.arrival_airport,
...
export default userReturnsearch;