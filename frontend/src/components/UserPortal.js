...
import styles from './user-portal.module.css'
...
const UserPortal = () => {
  ...
  return (
    <div className={styles['container']}>
      <Helmet>
        <title>User Portal - Travel Agency</title>
        <meta property="og:title" content="User Portal - Travel Agency" />
      </Helmet>
      <div className={styles['Top-container']}>
        <img
          alt="image"
          src="/playground_assets/airport-widescreen-wallpaper-hd-50126-51813-hd-wallpapers-1500w.jpg"
          loading="eager"
        ...
        <nav data-role="Header" className={styles['Navbar']}>
          ...
          <div className={styles['Right-side']}>
            <div className={styles['Links-container']}>
              ...
              <span className={styles['text02']}>Covid Regulations</span>
            ...
            <img
              alt="image"
              src="/playground_assets/my-profile-icon-png-3-200h.png"
            ...
            <div className={styles['Nav']}>
              ...
              <div className={styles['Right-side1']}>
                <div className={styles['Links-container1']}>
                  <span className={styles['text04']}>Home</span>
                  <span className={styles['text05']}>About</span>
        ...
        <div className={styles['Hero']}>
          <h1 className={` ${styles['text09']} ${projectStyles['heading']} `}>
            Book your flight
          </h1>
          <span className={styles['text10']}>Fast and easier than ever.</span>
          <a href="/UserPortal/UserSearch" className={styles['link01']}>
                  <SolidButton button="Search For a Flight"></SolidButton>
                </a>
      ...
      <div id="main-section" className={styles['Main']}>
        ...
        <span className={styles['text12']}>
          {' '}
          Not sure where to go? Check out our hottest destinations.
        </span>
        <div className={styles['Cards-container']}>
          <PlaceCard
            ...
            description="London has something for everyone with its vibrant culture. London is pure magic and that's why it's one of the world's most visited cities. From history and culture to fine food and exceedingly good times London has everything."
          ></PlaceCard>
          <PlaceCard
            city="Rome"
          ...
          <PlaceCard
            city="Cairo"
            image="/playground_assets/istockphoto-1180786967-170667a-300h.jpg"
