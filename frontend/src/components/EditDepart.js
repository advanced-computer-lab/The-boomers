...
class EditDepart extends Component {
  ...
  onSubmit = e => {
    e.preventDefault();
    const data = {
        departure_airport: this.state.depFlight.departure_airport,
        arrival_airport: this.state.depFlight.arrival_airport,
        cabin: this.state.cabin,
        departure_date: this.state.departure_date
    };   
    this.props.history.push({
        pathname: `/editdepartresults/${this.props.match.params.id}`,
        flightData: data
    })  
  };
